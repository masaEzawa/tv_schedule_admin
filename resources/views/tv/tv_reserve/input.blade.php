...
@if( $type == "edit" )
    ...
    {!! Form::model(
        $targetMObj,
        ['id'=> 'regEditForm', 'method' => 'POST', 'url' => route( 'tv_reserve.edit', ['id' => $targetMObj->id] ), 'enctype' => 'multipart/form-data']
    ) !!}
...
@else
    ...
    {!! Form::model(
        $targetMObj,
        ['id'=> 'regEditForm', 'method' => 'POST', 'url' => route( 'tv_reserve.create' ), 'enctype' => 'multipart/form-data']
    ) !!}
